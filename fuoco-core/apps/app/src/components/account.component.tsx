                ...
                <Accordion.Item id={Strings.profile} label={Strings.profile}>
                  ...
                  <div className={styles['info-container']}>
                    <Input
                      ...
                      icon={<IconBriefcase stroke={companyIconLit ? '#4AFFFF' : '#d1d5db'} />}
                      ...
                      onChange={(event) => AccountController.updateCompany(event.currentTarget.value)}
                    />
                  </div>
                </Accordion.Item>
                <Accordion.Item id={Strings.personalInformation} label={Strings.personalInformation}>
                  ...
                  <div className={styles['info-container']}>
                    <Input 
                      ...
                      onChange={(event) => AccountController.updateEmailAddress(event.currentTarget.value)}
                    />
                    <InputPhoneNumber
                      className={styles['info-input']}
                      ...
                      onChange={(value) => AccountController.updatePhoneNumber(value)}
                    />
                    <InputGeocoding 
                      className={styles['info-input']} 
                      label={Strings.location}
                      parentRef={containerRef}
                      icon={<IconMapPin stroke={locationIconLit ? '#4AFFFF' : '#d1d5db'}/>}
                      ...
                      onLocationChanged={(value, data) => AccountController.updateLocation(value, data)}
                    ...
                    <Listbox 
                      ...
                      onChange={(value) => AccountController.updateLanguage(value)}
