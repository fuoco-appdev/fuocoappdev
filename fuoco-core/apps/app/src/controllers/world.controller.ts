...
class WorldController extends Controller {
    ...
    public async loadImageAsync(
     ...
     public latLongToVector3(lat: number, lon: number, radius: number, height: number): THREE.Vector3 {
    ...
    public vector3ToLatLong(position: THREE.Vector3, radius: number): {lat: number, long: number} {
