    ...
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={
            'We are thrilled to invite you to our exclusive Cruthology Wine Club Discord server, where wine lovers from around the world come together to celebrate their passion for the divine nectar of the vine...'
          }
        />
        <meta
          property="og:image"
