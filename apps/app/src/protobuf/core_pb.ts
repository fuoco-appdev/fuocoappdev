...
/**
 * @generated from message core.CreateDeviceRequest
 */
export class CreateDeviceRequest extends Message<CreateDeviceRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "core.CreateDeviceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "type", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message core.UpdateDeviceRequest
 */
export class UpdateDeviceRequest extends Message<UpdateDeviceRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "core.UpdateDeviceRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message core.DevicesRequest
 */
export class DevicesRequest extends Message<DevicesRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "core.DevicesRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "stock_location_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message core.DeviceResponse
 */
export class DeviceResponse extends Message<DeviceResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "core.DeviceResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "created_at", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
/**
 * @generated from message core.DevicesResponse
 */
export class DevicesResponse extends Message<DevicesResponse> {
  /**
   * @generated from field: repeated core.DeviceResponse devices = 1;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "core.DevicesResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
