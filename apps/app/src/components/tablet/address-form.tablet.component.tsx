...
export default function AddressFormTabletComponent({
  isAuthenticated,
  values,
  errors,
  onChangeCallbacks,
      ...
      {!isComplete ? (
        ...
        <div
          className={[
            ...
            styles['completed-container-tablet'],
          ].join(' ')}
        >
          <div
            className={[
              styles['completed-details-container'],
              styles['completed-details-container-tablet'],
            ].join(' ')}
          >
            ...
            <div
              className={[
                ...
                styles['completed-details-tablet'],
              ].join(' ')}
            >
              <div
                className={[
                  styles['completed-details-text'],
                  styles['completed-details-text-tablet'],
                ].join(' ')}
              >
                {fullName}
              </div>
          ...
          <div
            className={[
              ...
              styles['edit-button-container-tablet'],
            ].join(' ')}
          >
            <Button
              touchScreen={true}
