...
goog.exportSymbol('proto.core.Customer', null, global);
goog.exportSymbol('proto.core.Customers', null, global);
 ...
 * @constructor
 */
proto.core.Customer = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.core.Customer, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.core.Customer.displayName = 'proto.core.Customer';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.core.Customers = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.core.Customers.repeatedFields_, null);
};
goog.inherits(proto.core.Customers, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.core.Customers.displayName = 'proto.core.Customers';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.core.Customer.prototype.toObject = function(opt_includeInstance) {
  return proto.core.Customer.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.core.Customer} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.core.Customer.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, ""),
    createdAt: jspb.Message.getFieldWithDefault(msg, 2, ""),
    email: jspb.Message.getFieldWithDefault(msg, 3, ""),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.core.Customer}
 */
proto.core.Customer.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.core.Customer;
  return proto.core.Customer.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.core.Customer} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.core.Customer}
 */
proto.core.Customer.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.core.Customer.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.core.Customer.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.core.Customer} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.core.Customer.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.core.Customer.prototype.getId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.core.Customer} returns this
 */
proto.core.Customer.prototype.setId = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.core.Customer.prototype.getCreatedAt = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.core.Customer} returns this
 */
proto.core.Customer.prototype.setCreatedAt = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.core.Customer.prototype.getEmail = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.core.Customer} returns this
 */
proto.core.Customer.prototype.setEmail = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.core.Customer.prototype.getFirstName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.core.Customer} returns this
 */
proto.core.Customer.prototype.setFirstName = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.core.Customer.prototype.getLastName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};
 ...
 * @return {!proto.core.Customer} returns this
 */
proto.core.Customer.prototype.setLastName = function(value) {
  return jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @const
 */
proto.core.Customers.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.core.Customers.prototype.toObject = function(opt_includeInstance) {
  return proto.core.Customers.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.core.Customers} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.core.Customers.toObject = function(includeInstance, msg) {
  var f, obj = {
    customersList: jspb.Message.toObjectList(msg.getCustomersList(),
    proto.core.Customer.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.core.Customers}
 */
proto.core.Customers.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.core.Customers;
  return proto.core.Customers.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.core.Customers} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.core.Customers}
 */
proto.core.Customers.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.core.Customer;
      reader.readMessage(value,proto.core.Customer.deserializeBinaryFromReader);
 ...
 * @return {!Uint8Array}
 */
proto.core.Customers.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.core.Customers.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.core.Customers} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.core.Customers.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.core.Customer.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Array<!proto.core.Customer>}
 */
proto.core.Customers.prototype.getCustomersList = function() {
  return /** @type{!Array<!proto.core.Customer>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.core.Customer, 1));
};


/**
 * @param {!Array<!proto.core.Customer>} value
 * @return {!proto.core.Customers} returns this
*/
proto.core.Customers.prototype.setCustomersList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.core.Customer=} opt_value
 * @param {number=} opt_index
 * @return {!proto.core.Customer}
 */
proto.core.Customers.prototype.addCustomers = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.core.Customer, opt_index);
};
 ...
 * @return {!proto.core.Customers} returns this
 */
proto.core.Customers.prototype.clearCustomersList = function() {
...
proto.core.Account.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requestStatus: jspb.Message.getFieldWithDefault(msg, 7, 0),
...
proto.core.Account.prototype.getLocation = function() {
  return /** @type{?proto.core.Location} */ (
    jspb.Message.getWrapperField(this, proto.core.Location, 5));
};
...
/**
 * optional RequestStatus request_status = 7;
 * @return {!proto.core.RequestStatus}
 */
proto.core.Account.prototype.getRequestStatus = function() {
  return /** @type {!proto.core.RequestStatus} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};
...
export const Customer = proto.core.Customer;
export const Customers = proto.core.Customers;
...
export const RequestStatus = proto.core.RequestStatus;
export const Secrets = proto.core.Secrets;
