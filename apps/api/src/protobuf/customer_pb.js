 ...
 * @return {string}
 */
proto.customer.UpdateCustomerResponse.prototype.getData = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.customer.UpdateCustomerResponse.prototype.setData = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.customer.UpdateCustomerResponse.prototype.getPassword = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.customer.UpdateCustomerResponse} returns this
 */
proto.customer.UpdateCustomerResponse.prototype.setPassword = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
...
export const AddCustomerToGroupRequest = proto.customer.AddCustomerToGroupRequest;
export const CustomerGroupResponse = proto.customer.CustomerGroupResponse;
export const CustomerMetadataResponse = proto.customer.CustomerMetadataResponse;
export const CustomerResponse = proto.customer.CustomerResponse;
export const CustomersRequest = proto.customer.CustomersRequest;
export const CustomersResponse = proto.customer.CustomersResponse;
export const RemoveCustomerFromGroupRequest = proto.customer.RemoveCustomerFromGroupRequest;
export const UpdateCustomerRequest = proto.customer.UpdateCustomerRequest;
export const UpdateCustomerResponse = proto.customer.UpdateCustomerResponse;
